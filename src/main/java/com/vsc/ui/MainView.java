...
import com.vsc.app.security.SecurityUtils;
import com.vsc.ui.components.BakeryCookieConsent;
import com.vsc.ui.components.OfflineBanner;
import com.vsc.ui.exceptions.AccessDeniedException;
import com.vsc.ui.views.HasConfirmation;
import com.vsc.ui.views.admin.products.ProductsView;
import com.vsc.ui.views.admin.users.UsersView;
import com.vsc.ui.views.login.LoginView;

import static com.vsc.ui.utils.BakeryConst.*;


@Viewport(VIEWPORT)
@PWA(name = "Bakery App Starter", shortName = "VaadinBakery",
		startPath = "login",
...
public class MainView extends AbstractAppRouterLayout implements BeforeEnterObserver {
	...
	protected void configure(AppLayout appLayout, AppLayoutMenu menu) {
		appLayout.setBranding(new Span("VaadinBakery"));
